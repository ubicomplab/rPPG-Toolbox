...
* [MR-NIRP](https://computationalimaging.rice.edu/databases/)
    * Nowara, Ewa & Marks, Tim & Mansour, Hassan & Veeraraghavan, Ashok. (2020). Near-Infrared Imaging Photoplethysmography During Driving. IEEE Transactions on Intelligent Transportation Systems.
    -----------------
    RawData/
    |   |-- subject1/
